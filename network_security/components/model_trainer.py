...
from network_security.utils.ml_utils.model.estimator import PhishingModel
...
import dagshub
dagshub.init(repo_owner='TaufeeqAi', repo_name='network_security_mlops', mlflow=True)
...
class ModelTrainer:
    ...
    def train_model(self,x_train,y_train,x_test,y_test):
        ...
        save_object(self.model_trainer_config.trained_model_file_path,obj=PhishingModel)
